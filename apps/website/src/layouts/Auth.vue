<template>
  <div class="w-full h-full flex flex-row fixed top-0 left-0 bg-white items-center justify-center">
    <div
    ...
    <sofa-image-loader
      ...
      <div
        ...
        <div class="w-full flex flex-row">
          <div class="bg-white custom-border px-5 py-3">
            <sofa-normal-text :customClass="'!font-bold !text-base gap-2 flex flex-row'">
              <span> Did you know? </span>
              <sofa-icon :name="'idea'" :customClass="'h-[20px]'" />
            </sofa-normal-text>
          </div>
        </div>
        <sofa-normal-text :color="'text-white'" :customClass="' text-left !text-2xl'">
          The human brain can store about 2.5 petabytes of information? That's
          roughly equivalent to three million hours of TV shows.
        </sofa-normal-text>
      </div>
    </sofa-image-loader>
  </div>
