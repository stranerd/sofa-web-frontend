	...
	<div class="w-full flex flex-col gap-4">
		<div class="w-full flex flex-col gap-4">
			<div class="bg-primaryPurple rounded-custom px-4 py-4 flex flex-col gap-2">
				<div class="flex flex-row items-center justify-start gap-2" v-for="(item, index) in videoUploadSteps" :key="index">
		...
		<div
			...
			<div class="mdlg:!w-auto w-full flex flex-col">
				<sofa-button :padding="'px-5 mdlg:!py-2 py-3'" :customClass="'mdlg:!w-auto w-full'"> Add </sofa-button>
			</div>
		</div>
	</div>
</template>
