  ...
  <div class="w-full flex flex-col gap-5 mdlg:!px-0 px-4">
    ...
    <div v-if="allRequests.length"
      ...
      <div class="w-full flex flex-col gap-4" v-if="showRequests">
        <div class="w-full flex flex-row gap-ems-center justify-between" v-for="(item, index) in allRequests"
          :key="index">
          ...
          <div class="flex flex-row gap-ems-center">
            ...
            <sofa-normal-text :color="'text-primaryGreen'" :custom-class="'cursor-pointer'" @click="
    ...
    <div :class="`w-full flex flex-col gap-4 mdlg:bg-white mdlg:rounded-[16px]  md:!px-5 md:!py-5 mdlg:px-4 mdlg:py-4 mdlg:shadow-custom ${allStudents.length > 0 ? 'bg-white rounded-[8px] px-3 py-3' : ''
      }`">
      <div class="w-full flex-row items-center justify-between flex">
        ...
        <div class="mdlg:flex flex-row items-center gap-dden">
          <div class="flex flex-row items-center gap-acity-60 cursor-pointer" @click="copyJoinLink()">
            <sofa-normal-text> Copy join link </sofa-normal-text>
          ...
          <div class="w-full flex flex-row items-center justify-between" v-for="(item, index) in allStudents"
            ...
            <div class="flex flex-row items-center gap-
              <sofa-avatar
                ...
                <div class=" flex flex-row gap-ems-center">
              <sofa-normal-text :color="'text-primaryRed'" :customClass="'cursor-pointer'" @click="
                selectedMember = item.emailId
              showRemoveMember = true;
              ">
                Remove
      ...
      <sofa-empty-state v-else :title="'No students'" :subTitle="'Your students have free access all contents you create'"
        :actionLabel="'Add students'" :action="() => {
          showAddStudents()
        }
          " />
    </div>
    ...
    <sofa-delete-prompt v-if="showRemoveMember" :title="'Are you sure you want to remove this student?'" :subTitle="``"
      :close="() => {
