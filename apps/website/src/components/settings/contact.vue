	...
	<div class="w-full flex flex-col gap-5 mdlg:!px-0 px-4">
		<div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
			...
			<div class="w-full flex flex-row items-center gap-5 flex-wrap">
				<a href="mailto:support@stranerd.com" target="_blank"><sofa-icon :customClass="'h-[15px]'" :name="'email-social'" /></a>
				<a href="Wa.me/+2348130322791" target="_blank"> <sofa-icon :customClass="'h-[22px]'" :name="'whatsapp-social'" /></a>
		...
		<div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
			...
			<div class="w-full flex flex-row justify-end">
				<div class="flex flex-row">
					<sofa-button :padding="'px-7 py-2'" :customClass="'!w-auto'" @click="sendFeedback()"> Send </sofa-button>
				</div>
			</div>
		</div>
	</div>
