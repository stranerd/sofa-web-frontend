<template>
  <div class="w-full flex flex-col gap-5 mdlg:!px-0 px-4">
      ...
      <div class="w-full flex flex-col gap-1">
        ...
        <div class="mt-3 grid grid-cols-2 gap-3 pt-4">
          <div @click="showFundWallet()"
            class="col-span-1 flex flex-row items-center py-3 px-3 gap-rsor-pointer custom-border justify-center border-[2px] border-[#E1E6EB]">
          ...
          <div @click="showWalletWithdraw()"
            class="col-span-1 flex flex-row items-center py-3 px-3 gap-stom-border cursor-pointer justify-center border-[2px] border-[#E1E6EB]">
    ...
    <div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom pb-7">
      ...
      <div class="w-full flex flex-row items-center gap--3 py-3 cursor-pointer" @click="Logic.Payment.initialPayment()">
      ...
      <div :class="`w-full flex flex-row items-center gap--3 py-3 border-[2px] justify-between ${selectedMethodId == method.id
        ? 'border-[#E1E6EB]'
        : 'border-[#E1E6EB]'
        ...
        <div class="flex flex-row items-center gap-
          <sofa-icon :customClass="'h-[20px]'" :name="'card'" />
            ...
            <div class=" flex flex-row items-center gap- <span
        class="px-4 py-1 bg-primaryGreen rounded-[14px] cursor-pointer" v-if="method.primary">
    ...
    <div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
      ...
      <div class="w-full flex flex-col gap-2" v-if="transactions.length">
        <div v-for="(transaction, index) in transactions" :key="index" :class="`w-full flex flex-col gap-1 pb-2 cursor-pointer  ${index != transactions.length - 1
          ...
          <div class="w-full flex flex-row justify-start gap-ems-center">
  ...
  <sofa-modal v-if="showModal" :close="() => {
      ...
      <div
        ...
        <div class="w-full flex flex-col gap-5 mdlg:!px-0 px-4" v-if="modalContent == 'fund_wallet'">
          ...
          <div class="w-full flex flex-col gap-2 border-t-[1px] border-[#F1F6FA] pt-3">
            <div :class="`w-full flex flex-row items-center gap--3 py-3  bg-[#F1F6FA] ${fundWalletMethod == 'online'
            ...
            <div :class="`w-full flex flex-row items-center gap--3 py-3 bg-[#F1F6FA]  ${fundWalletMethod == method.id
              ? 'border-primaryBlue border-[2px]'
              : ''
    ...
    " v-for="(method, index) in PaymentMethods.results" :key="index">
            ...
            <div
              class="w-full flex flex-row items-center gap--3 py-3 cursor-pointer border-[2px] custom-border border-[#E1E6EB]"
