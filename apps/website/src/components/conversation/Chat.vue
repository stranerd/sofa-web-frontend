<template>
  <div :class="`w-full flex flex-row items-center justify-between relative gap-3 px-3 py-3  custom-border hover:bg-[#E5F2FD] cursor-pointer ${chat.selected ? 'bg-[#E5F2FD]' : ''
    }  ${customClass}`">
    <div class="flex flex-row gap-full">
    ...
    <div
      v-if="chat.hover"
      class="right-0 top-0 absolute h-full bg-[#E5F2FD] rounded-r-[8px] px-4 flex flex-row items-center gap-
    >
      <sofa-icon
