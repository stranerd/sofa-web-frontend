<template>
  <dashboard-layout>
    ...
    size: 'h-[34px]',
        ...
        <template v-else>
          <sofa-empty-state :title="'Complete your tutor verification'" :subTitle="'Apply to become a tutor on SOFA'"
            :actionLabel="'Become a tutor'" :action="() => {
    ...
    <template v-slot:left-session>
      <div
        ...
        <div class="w-full flex flex-row justify-start pt-4 pb-2"
      ...
      <sofa-delete-prompt v-if="showDeleteConvo" :title="'Are you sure?'"
        :subTitle="`This action is permanent. All messages in this conversation would be lost`" :close="() => {
    ...
    <template v-slot:middle-session>
      <div
        ...
        <div
          ...
          <div class="flex flex-row items-center gap-3">
            ...
            <div class="flex flex-col">
              ...
              <sofa-normal-text :customClass="'!font-bold w-full flex flex-row justify-start !px-0 !py-0'" v-else>
          ...
          <div class="flex flex-row" v-if="!editTitle && conversationTitle != 'New Chat'" @click="editTitle = true">
            <sofa-icon :name="'edit-gray'" :custom-class="'h-[15px] cursor-pointer'" />
          </div>
        </div>
        ...
        <div class="w-full flex flex-col mdlg:!hidden px-4 gap-3 pt-1" v-if="chatList.length || tutorRequestList.length">
          <div class="w-full flex flex-row gap-2 items-center mdlg:hidden" v-if="Logic.Users.getUserType() == 'student'">
            <sofa-normal-text :customClass="'!font-bold'">
              All chats
            </sofa-normal-text>
          </div>
        ...
        <div class="w-full mdlg:flex flex-row items-start justify-start px-4 py-4 hidden" v-if="itIsTutorRequest">
          <div
        ...
        <div class="w-full py-4 border-t-[1px] mdlg:!flex hidden border-[#E1E6EB] sticky bottom-0 px-4 bg-white">
