<template>
  <global-layout>
    <dashboard-layout>
      ...
      <div
        class="w-full flex flex-col h-[50px] items-center justify-center px-4"
      >
      ...
      <template v-slot:left-session>
        ...
        >
          ...
          >
            <sofa-header-text
              :customClass="'text-left mdlg:!text-base text-sm'"
            >
              All Chats
            </sofa-header-text>
          </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                  <sofa-normal-text
                    :customClass="'mdlg:!text-center text-left'"
                  >
                    {{ content.body }}
                  </sofa-normal-text>
                </div>
