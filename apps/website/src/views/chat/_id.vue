  ...
  <sub-page-layout>
    <div class="w-full h-full flex-grow flex flex-col justify-between absolute">
      <div
        ...
        <div class="space-x-3 flex flex-row items-center min-w-[60px] justify-end" v-if="!itIsTutorRequest">
      ...
      <div class="w-full h-full flex flex-grow bg-white flex-col space-y-5 overflow-y-auto px-4 py-6"
        ...
        <div @click.stop="() => {
          ...
          <div
            ...
            <template v-if="UserWallet.subscription.data.tutorAidedConversations > 0">
              <div class="w-full flex flex-row items-center justify-start space-x-2 cursor-pointer" @click="
                showMoreOptions = false
              showAddTutor = true;
