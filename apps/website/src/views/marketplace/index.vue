<template>
  <expanded-layout layoutStyle="!w-full">
    <div class="w-full mdlg:!flex hidden flex-col gap-5 py-8 pb-14 bg-primaryPurple justify-center items-center">
      ...
      <div class="w-[40%] flex flex-col pt-4">
        <div
          ...
          <div class="flex flex-row gap-ems-center flex-grow">
    ...
    <div class="w-full px-4 flex mdlg:!hidden flex-col sticky top-0 left-0 py-4 bg-backgroundGray z-[9999]">
      <div class="w-full shadow-custom px-4 py-1 bg-white custom-border flex flex-row gap-ems-center justify-start">
        <div class="flex flex-row gap-ems-center flex-grow" @click="Logic.Common.GoToRoute('/marketplace/search')">
    ...
    <div class="mdlg:!w-[85%] lg:!w-[75%] w-full flex flex-col gap-6 md:!gap-7 mdlg:!px-0 px-0">
      ...
      <div v-if="false" class="w-full flex flex-row flex-nowrap overflow-x-auto scrollbar-hide mdlg:!pl-0 pl-4">
        <div
          class="mdlg:!w-full mdlg:!grid mdlg:!grid-cols-3 mdlg:!gap-4 mdlg:!px-0 flex flex-row gap-lg:!gap-gap-dlg:!py-0 mdlg:pt-0 mdlg:!pr-0 pr-4">
