<template>
  <auth-layout>
    <div class="w-full h-full flex-grow flex flex-col justify-start relative md:!px-9 md:!py-5 py-4 px-4">
      ...
      <div class="h-full flex flex-col items-center justify-center space-y-4 w-full">
        <div class="flex md:!flex-row flex-col space-y-3 md:!space-x-6 md:!space-y-0 justify-center items-center w-full">
