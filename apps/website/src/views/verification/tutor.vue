    ...
    <div class="w-full flex flex-col gap-5 mdlg:px-0 px-4">
      ...
      <template v-if="currentStep == 'profile'">
        <div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
          ...
          <div class="w-full flex flex-row items-center justify-start py-2 gap-
          >
            <sofa-image-loader
              :customClass=" `w-[90px] h-[90px] flex flex-row items-center justify-center relative bg-grayColor
            border-[1px] border-grayColor rounded-full`" :photoUrl="profileImageUrl ?? ''">
          ...
          <sofa-textarea :hasTitle="false"
            ...
            :placeholder="'Bio'" :richEditor="false" v-model="updateProfileForm.description" />
        </div>
        ...
        <div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
          ...
          <sofa-file-attachment :isWrapper="true" :customClass="'custom-border border-[2px] border-dashed border-primaryPurple bg-[#F1F6FA] py-4 px-4 items-center jusify-center flex !flex-row gap-
                                v - model=" tutorRequestForm.qualification" accept="application/pdf, image/*"
            :is-multiple=" true ">
            <template v-slot:content>
              <div class="w-full flex mdlg:flex-row mdlg:gap-ex-col gap-1 mdlg:gap-0 items-center justify-center">
        ...
        <div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
          ...
          <sofa-file-attachment :isWrapper=" true " :customClass="
            'custom-border border-[2px] border-dashed border-primaryPurple  bg-[#F1F6FA] py-4 px-4 items-center jusify-center flex !flex-row gap-
            v - model=
          " tutorRequestForm.verification" accept="image/*">
            <template v-slot:content>
              <div class="w-full flex mdlg:flex-row mdlg:gap-ex-col gap-1 mdlg:gap-0 items-center justify-center">
                <sofa-icon :name=" 'upload-purple' " :customClass=" 'h-[16px]' " />
      ...
      <template v-if=" currentStep == 'test' ">
        ...
        <div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
          ...
          <div class="w-full flex flex-col" v-if=" SingleTutorRequest ">
            ...
            <template v-else>
              <div :class="
                `flex flex-row ${SingleTutorRequest.testFinished ? 'opacity-50' : ''
                  } `
