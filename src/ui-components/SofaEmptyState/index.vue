<template>
	<div :class="`w-full flex flex-col gap-3 justify-center items-center py-9 px-6 rounded-custom bg-primaryPurple ${customClass}`">
		...
		<svg v-else width="30" height="30" viewBox="0 0 30 30" class="h-[28px]" fill="white">
			...
			<path
				d="M15 8.33268C15.7363 8.33268 16.3333 8.92964 16.3333 9.66601C16.3333 10.4024 15.7363 10.9993 15 10.9993C14.2636 10.9993 13.6666 10.4024 13.6666 9.66601C13.6666 8.92964 14.2636 8.33268 15 8.33268Z" />
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
