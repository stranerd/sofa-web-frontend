	...
	<div id="accountability" class="w-[90%] mx-auto max-w-[1800px]">
		<div class="relative flex mdlg:flex-row flex-col items-center my-8 mdlg:mt-20">
			...
			<div class="w-full mdlg:w-1/2 flex items-center justify-center">
				<img
					src="/images/landing/organization-accountability.png"
			...
			<div class="w-full mdlg:w-1/2 flex flex-col items-center mdlg:items-start text-center mdlg:text-left gap-2">
				<h3 class="text-[20px] md:text-[36px] font-bold md:leading-[54px]">Accountability</h3>
				<p class="text-[16px] md:text-[24px] leading-[36px]"></p>
				<p class="w-4/5 text-[14px] md:text-[16px] leading-[24px] tracking-wide">
					Accurately track the progress of your students with our interface designed specially for your facility.
				</p>
				<RouterLink
					to="#"
			...
			<img class="hidden mdlg:block absolute right-20 -top-10" src="/images/landing/marketplace-top.png" />
		</div>
	</div>
</template>
