<template>
	<div class="w-full flex flex-col gap-5 mdlg:!px-0 px-4">
		<div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
			<sofa-header-text :size="'xl'" :custom-class="'text-left'" content="Contact details" />

			<div class="w-full flex flex-row items-center gap-5 flex-wrap">
				<a href="mailto:support@stranerd.com" target="_blank"><sofa-icon :custom-class="'h-[15px]'" :name="'email-social'" /></a>
				<a href="Wa.me/+2348130322791" target="_blank"> <sofa-icon :custom-class="'h-[22px]'" :name="'whatsapp-social'" /></a>
				<a href="https://instagram.com/stranerdapp?igshid=MzRlODBiNWFlZA==" target="_blank">
					<sofa-icon :custom-class="'h-[18px]'" :name="'instagram-social'" />
				</a>
				<a href="https://www.tiktok.com/@stranerd?_t=8fCMYT3iCbl&_r=1" target="_blank">
					<sofa-icon :custom-class="'h-[18px]'" :name="'tiktok-social'" />
				</a>
				<a href="https://x.com/stranerds?s=21&t=BufB-e-PFvnG949QyKQtgw" target="_blank">
					<sofa-icon :custom-class="'h-[18px]'" :name="'twitter-social'" />
				</a>
			</div>
		</div>

		<div class="w-full flex flex-col gap-4 bg-white rounded-[16px] md:!px-5 md:!py-5 px-4 py-4 shadow-custom">
			<sofa-header-text :size="'xl'" :custom-class="'text-left'" content="Give feedback" />
			...
			<div class="w-full flex flex-row justify-end">
				<div class="flex flex-row">
					<sofa-button :padding="'px-7 py-2'" :custom-class="'!w-auto'" @click="sendFeedback()"> Send </sofa-button>
				</div>
			</div>
		</div>
	</div>
