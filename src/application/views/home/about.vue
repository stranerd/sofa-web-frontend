<template>
	<main class="w-full flex flex-col gap-20 bg-white max-w-[1800px] mx-auto">
		...
		<!-- About us -->
		<div class="w-[80%] mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative">
			<div class="w-full order-2 md:order-1 md:w-3/5 flex flex-col gap-1">
				...
				<p class="text-[16px]">
					...
					improving education, we've developed a cutting-edge platform that addresses these challenges head-on.
				</p>
			</div>
			<div class="w-full order-1 md:order-2 md:w-2/5 flex items-center justify-center">
				<img src="/images/about-us.png" />
			</div>
			<img class="hidden mdlg:block absolute -bottom-10 left-[50%] right-0" src="/images/about-us-vector.png" />
		</div>
		<!-- Our Vision -->
		<div class="w-[80%] mx-auto flex md:flex-row flex-col items-center justify-between gap-12">
		...
		<!-- Our Mission -->
		<div class="w-[80%] mx-auto flex md:flex-row flex-col items-center justify-between gap-12 relative">
			...
			<div class="w-full md:w-2/5 order-1 md:order-2 flex items-center justify-center">
		...
		<!-- What sets us apart -->
		<div
			class="styled-bg w-[80%] min-h-[600px] mdlg:h-[600px] mx-auto rounded-[20px] flex flex-col mdlg:flex-row items-center justify-between gap-6 px-8 py-20 mdlg:px-0 mdlg:py-0">
		...
		<!-- Our Values -->
		<div class="w-[80%] mx-auto flex flex-col mdlg:flex-row items-center gap-6 mdlg:gap-20">
