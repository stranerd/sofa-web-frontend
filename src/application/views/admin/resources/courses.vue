	...
	<AdminLayout title="Courses">
		<div class="flex flex-col bg-white rounded-2xl">
			<div class="flex justify-between items-center py-1">
				<SofaHeading content="Courses" class="px-4 w-[60%]" size="mid" />
...
import { useCoursesList } from '@app/composables/study/courses-list'

const { currentlyViewing, limitText, next, previous, canNext, canPrev } = useCoursesList()
</script>
