	...
	<AdminLayout title="Classes">
		<div class="flex flex-col bg-white rounded-2xl">
			<div class="flex justify-between items-center py-1">
				<SofaHeading content="Classes" class="px-4 w-[60%]" size="mid" />
...
import { useClassesList } from '@app/composables/organizations/classes-list'

const { currentlyViewing, limitText, next, previous, canNext, canPrev } = useClassesList()
</script>
