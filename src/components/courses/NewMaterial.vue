    ...
    <div class="w-full grid grid-cols-2 h-full md:!gap-6 gap-3">
      <template v-for="(item, index) in newMaterialOptions" :key="index">
        <div
          ...
          class="col-span-1 custom-border md:!h-[280px] h-[120px] border-[#E1E6EB] border-[2px] flex flex-col space-y-3 items-center justify-center cursor-pointer"
        >
        ...
        >
          <template v-slot:content>
            <div
              class="w-full custom-border md:!h-[280px] h-[120px] border-[#E1E6EB] border-[2px] flex flex-col space-y-3 items-center justify-center cursor-pointer"
            >
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const addFile = (file: Blob, type: "video" | "image" | "document") => {
      addCourseFileForm.description = `${capitalize(type)} file for ${
        SingleCourse.value.title
      }`;
