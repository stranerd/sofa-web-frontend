      ...
      >
        ...
        >
          ...
          <div class="w-full grid grid-cols-2 gap-3 pt-2">
            <sofa-normal-text
              ...
              "
              :customClass="`!font-semibold cursor-pointer pb-2 col-span-1 items-center justify-center ${
                selectedTab == tab.key
        ...
        <div class="w-full flex flex-col space-y-3 md:!px-0 px-4">
          <template v-if="selectedData.length">
            <sofa-activity-card
              v-for="(activity, index) in selectedData"
              :key="index"
              :activity="activity"
              :isWrapped="true"
              :custom-class="'!bg-backgroundGray !shadow-none cursor-pointer'"
              :centralizeExtras="true"
              @click="
            ...
            >
              <template v-slot:extra>
                <span class="pr-3">
                  <sofa-icon
                    :name="
                      selectedItems[selectedTab].filter(
          ...
          <sofa-empty-state
            v-else
            :title="`There are no ${
              selectedTab == 'quiz' ? 'Quizzes' : 'Courses'
            } here`"
