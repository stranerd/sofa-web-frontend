<template>
  <div
    ...
    <div :class="`flex mdlg:!flex-row  ${isWrapped
      ...
      } mdlg:gap-dlg:gap-0 items-start w-full `">
      ...
      <div class="grid grid-cols-10 w-full gap-2 items-center h-full relative">
        <div :class="`flex flex-col gap-2  col-span-10 h-full w-full `">
          ...
          <div class="flex flex-row items-center gap-ex-grow justify-between w-full">
            <router-link :to="`/profile/${activity.user.id}`" class="gap-ex flex-row items-center cursor-pointer">
