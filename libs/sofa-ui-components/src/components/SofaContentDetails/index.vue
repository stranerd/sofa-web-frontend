<template>
  <div
      ...
      <div
        ...
        <div :class="` ${hasPadding ? 'mdlg:!w-[25%]' : 'mdlg:!w-[33%]'
          ...
          <sofa-image-loader :customClass="'mdlg:!w-full w-full mdlg:!h-full h-[200px] custom-border relative'"
            ...
            <div class="flex flex-row gap-ems-center justify-end absolute bottom-0 left-0 w-full px-2 py-2"
        ...
        <div :class="`flex flex-col gap-2 flex-grow   ${hasPadding
          ...
          <div class="w-full flex flex-row items-center justify-between">
            ...
            <div class="mdlg:!flex flex-row items-center justify-end gap-dden">
          ...
          <div class="w-full flex flex-row gap-ems-center" v-if="!isMinimal">
            <div class="flex flex-row gap-ems-center">
          ...
          <div class="w-full flex flex-row items-center gap-stify-between">
            <div class="flex flex-row items-center gap-
              <div class=" gap-ex flex-row items-center" v-if="!isMinimal">
    ...
    <div class="w-full flex flex-row gap-ems-center py-2 flex-nowrap overflow-x-auto scrollbar-hide">
  ...
  <div :class="`w-full flex flex-row gap-ems-center border-b-[1px] border-[#F1F6FA] mdlg:!relative sticky mdlg:!pr-5 pr-4 top-0 left-0 z-50 bg-white pt-3 mdlg:!pt-0  ${hasPadding ? 'px-4' : ''
    }`">
  ...
  <div :class="`w-full flex flex-col rounded-b-[16px] ${hasPadding ? 'px-4' : ''
    ...
    <div class="w-full bg-[#F1F6FA] custom-border px-4 py-4 flex flex-row gap-lg:!items-center items-start">
      <div>
  ...
  <div :class="`w-full flex flex-col rounded-b-[16px] ${hasPadding ? 'px-4' : ''
    ...
    <div
      class="lg:!w-full mdlg:!flex mdlg:!flex-col mdlg:!gap-4 flex flex-row gap-lg:!gap-gap-owrap overflow-x-auto scrollbar-hide"
      v-if="similarContents?.length">
      <div
        class="mdlg:!w-full mdlg:!flex mdlg:!flex-col mdlg:!gap-4 flex flex-row gap-lg:!gap-gap-x-0 py-2 mdlg:!py-0 mdlg:pt-0 mdlg:!pr-0 pr-4">
        <sofa-activity-card v-for="(activity, index) in similarContents" :key="index" :activity="activity"
          :customClass="'!bg-[#F1F6FA] cursor-pointer'" @click="Logic.Common.GoToRoute(`/marketplace/${activity.id}`)" />
      </div>
    </div>
    <template v-else>
