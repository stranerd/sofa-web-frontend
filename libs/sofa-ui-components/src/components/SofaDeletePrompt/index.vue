  ...
  >
    ...
    >
      ...
      >
        ...
        <div
          class="w-full flex flex-row items-start justify-center mdlg:!hidden px-4 pt-3"
        >
        ...
        >
          <div
            class="md:!-auto col-span-1 flex flex-col"
            v-for="(button, index) in buttons"
            :key="index"
          >
            <sofa-button
              :textColor="!button.isClose ? 'text-white' : 'text-grayColor'"
              :bgColor="!button.isClose ? 'bg-primaryRed' : 'bg-white'"
              :padding="'px-4 py-2'"
