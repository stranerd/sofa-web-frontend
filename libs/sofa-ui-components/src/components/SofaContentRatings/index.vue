	...
	<div :class="`w-full flex flex-col ${hasWhiteBox ? 'gap-4' : 'gap-3'
		...
		<div :class="`w-full  ${hasWhiteBox ? 'bg-white shadow-custom' : 'bg-lightGray'
			...
			<div class="flex flex-col py-4 px-2 mdlg:!w-[200px] w-[200px]">
				<div
					class="mdlg:!px-7 px-3 py-4 flex flex-col gap-2 items-center justify-center border-r-2 border-darkLightGray">
			...
			<div class="w-full flex flex-col gap-2">
				<div class="w-full flex flex-row items-center justify-between gap-3" v-for="(rating, index) in data.stats"
					:key="index">
