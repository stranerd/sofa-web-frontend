<template>
      ...
      <template #item="{ element, index }">
        <div :class="`w-full px-4 py-4 rounded-[12px] cursor-pointer ${selectedQuestion == index ? 'bg-[#E6F5FF]' : 'bg-[#F1F6FA]'
          ...
          <div class="w-full h-[144px] bg-cover relative">
            ...
            <div class="absolute top-0 left-0 h-full w-full flex flex-row gap-ems-center justify-center"
              v-if="element.hover">
              <div @click.stop="
  ...
  <div
    ...
    <div class="w-full flex flex-row flex-nowrap overflow-x-auto scrollbar-hide">
      <draggable class="flex flex-row gap-ems-center flex-nowrap whitespace-nowrap pr-4" v-model="questions"
