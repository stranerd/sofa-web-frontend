<template><div class="w-full flex flex-col h-full gap-4 relative" v-if="data">
  <div
  ...
  <div class="flex flex-col gap-3 h-full w-full px-4">
    <template v-if="type == 'quiz'">
      ...
      <div class="w-full flex items-center gap-ex-row">
      ...
      <div class="w-full flex flex-col gap-2">
        ...
        <div class="w-full flex flex-row items-center">
          <div class="gap-ex flex-row items-center">
      ...
      <template v-if=" type=='document'">
        <sofa-text-field
          ...
          type=" text" :name="'Document title'" ref="document_title" v-model="dataReactive.title"
          :updateValue="dataReactive.title" :placeholder="'Document title'" :hasTitle="true"
...
<div
    ...
    <div class="w-full flex flex-row items-center justify-start gap-rsor-pointer" @click="
