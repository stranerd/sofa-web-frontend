<template>
  <div :class="`col-span-1 flex flex-col gap-2 px-3 py-3 cursor-pointer custom-border ${customClass}`">
    ...
    <div class="flex flex-row gap-ems-center justify-between pt-1" v-if="content.user">
      <router-link :to="`/profile/${content.user.id}`" class="gap-ex flex-row items-center cursor-pointer">
