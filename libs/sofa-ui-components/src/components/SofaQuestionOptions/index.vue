        ...
        <div class="w-full flex flex-col gap-2 relative" v-if="option.show">
          ...
          <div class="flex flex-row items-center gap-
            ...
            /> -->
              ...
              <div
                class=" w-full flex flex-row flex-wrap gap-3" v-if="!option.hasImage">
            <span @mouseenter="item.active = true" @mouseleave="item.active = false" :class="`px-4 py-2  ${item.name == option.value ? 'bg-primaryPurple' : 'bg-[#EFF2F5]'
              } rounded-[8px] flex flex-row items-center justify-center gap-ursor-pointer`"
...
<div
    ...
    >
      <div
        class="w-full flex flex-row items-center justify-start gap-rsor-pointer"
