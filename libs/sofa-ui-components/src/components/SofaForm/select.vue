  ...
  <div :class="`flex flex-col space-y-2 ${defaultSize} `">
    ...
    >
      ...
      <div
        v-if="showOption"
        @click.stop="null"
        :class="`w-full hidden mdlg:!flex flex-col top-[101%] left-0 bg-white z-[999999999999] max-h-[320px] ${
          isAbsolute ? 'min-w-[200px]' : ' mt-3'
        }  overflow-y-auto rounded-md pb-3 px-3 shadow-md  ${
          isAbsolute ? 'absolute' : ''
        }`"
      >
        <div
          class="w-full py-2 sticky top-0 bg-white space-x-3 flex flex-row items-center justify-between"
          v-if="autoComplete"
        >
          <sofa-text-field
            placeholder="Search"
        ...
        <div
          ...
          v-if="!autoComplete"
        ></div>
        <!-- <div class="w-full pb-2 sticky top-0 left-0">
          <sofa-normal-text v-if="placeholder" :custom-class="'font-semibold'">
            {{ placeholder }}
          </sofa-normal-text>
        </div> -->
        <div
      ...
      >
        ...
        >
          <div
            class="flex items-center flex-col justify-center sticky top-0 space-y-2 bg-white w-full pt-3 pb-1"
          >
            ...
            <div
              class="border-[1px] w-full border-gray-200 rounded bg-white"
              v-if="autoComplete"
            >
              <input
                ref="select"
